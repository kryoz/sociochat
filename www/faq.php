			...
			<div class="panel-body">
				<div id="accordion" class="panel-group">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordion" href="#rules">Какие действуют правила в СоциоЧате?</a>
							</h4>
						</div>
						<div id="rules" class="panel-collapse">
							<div class="panel-body">
								<p>Как мне не хотелось этого делать, но придется провести черту в действиях пользователей проекта. Итак, что здесь считается "хорошо" и что "плохо"?<br>
									...
									<ol>
										...
										<li>
											...
											<ol>
												...
												<li>Публиковать ссылки на контент порнографического характера или использовать аватарку подобного характера</li>
										...
										<li>
											При регулярном нарушении Правил Администратор в праве применить необходимые меры по ограничению доступа нарушителя в СоциоЧат
										</li>
									</ol>
								</p>
							</div>
						...
						<div id="socionic" class="panel-collapse collapse">
							<div class="panel-body">
								<p>Соционика - это концепция из сферы психологии, имеющая в основе типологию Юнга. <br>
									...
									Нельзя называть соционику наукой в строгом смысле слова. Тем не менее, неослабевающий интерес к ней на протяжении многих лет доказывает, что это не просто теория о сферических личностях в вакууме, а нечто находящее подтверждение в реальном мире.
									Более подробно ознакомиться вы можете с помощью запроса в любимом поисковом сервисе.
								</p>
							</div>
						</div>
					</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordion" href="#f3">Я не могу зайти под своим именем снова или меня чат "забывает".</a>
							</h4>
						</div>
					...
					<div class="panel panel-default">
						...
						<div id="f9" class="panel-collapse collapse">
							<div class="panel-body">
								<p>Используйте сервис <a href="http://pleer.com" target="_blank">pleer.com</a>, чат использует его медиатеку</p>
							</div>
						</div>
					</div>
