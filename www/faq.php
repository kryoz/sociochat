			...
			<div class="panel-body">
				<div id="accordion" class="panel-group">
									...
									<ol>
										...
										<li>
											...
											<ol>
												...
												<li>Выдавать себя за другого человека (например, копировать аватару и делать производную от имени жертвы)</li>
											</ol>
										</li>
										<li>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordion" href="#socionic">Что такое социочат и при чём тут соционика?</a>
							</h4>
						</div>
