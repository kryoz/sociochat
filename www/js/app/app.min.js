...
sendMessageButton:$("#send"),setProperties:$("#set-profile-info"),setRegInfo:$("#set-reg-info"),removeAvatar:$("#remove-avatar"),doLogin:$("#do-login"),doMusicSearch:$("#do-music-search"),doHashSearch:$("#do-hash-search"),hashPanel:$("#hashes"),music:$("#music"),musicInput:this.music.find("input[name=song]"),menuExit:$("#menu-exit"),menuChat:$(".navbar-brand a"),menuChannels:$("#menu-channels"),navbar:$(".navbar-nav"),regLink:$("#reg-info"),regPanel:$("#reg-panel"),audioPlayer:$("#player"),musicLink:$('a[href="#music"]').parent(),
