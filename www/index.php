            ...
            <div class="collapse navbar-collapse">
                <ul role="navigation" class="nav navbar-nav">
                    ...
                    <li style="display: none">
                        <a href="#" id="menu-dualize-stop" class="tip"
                           title="<?= $lang->getPhrase('index.StopDualSearchTip') ?>"><span
                                class="glyphicon glyphicon-remove"></span> <?= $lang->getPhrase('index.StopDualSearch') ?>
                        </a>
                    </li>
                    <li style="display: none">
                        <a href="#" id="menu-exit" class="tip"
                           title="<?= $lang->getPhrase('index.ReturnToPublicTip') ?>"><span
                                class="glyphicon glyphicon-home"></span> <?= $lang->getPhrase('index.ReturnToPublic') ?>
                        </a>
                    </li>

                    <li>
                        <a href="/faq.php" target="_blank" class="tip"
                           title="<?= $lang->getPhrase('index.FAQtip') ?>"><span
...
<div id="dont_forget" style="display: none">
    <form action="" method="post" autocomplete="on">
        <input type="email" required class="form-control" autocomplete="on"
               placeholder="<?= $lang->getPhrase('Email') ?>" id="login-name">
        <input type="password" required class="form-control" autocomplete="on"
               placeholder="<?= $lang->getPhrase('Password') ?>" id="login-password">
