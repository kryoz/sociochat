...
<div class="panel panel-default tab-pane" id="profile">
	...
	<div class="panel-body">
		...
		<div class="row btn-vert-block form-group">
			<div class="col-md-3 btn-vert-block">
				<input type="text" class="form-control" placeholder="<?=$lang->getPhrase('profile.Name')?>" id="profile-nickname">
			</div>
			<div class="col-md-3 btn-vert-block">
				<input type="text" class="form-control" placeholder="<?=$lang->getPhrase('profile.City')?>" id="profile-city">
			</div>
	...
	<div class="panel-heading" style="border-top: 1px solid #ddd;">
		<a href="#" id="reg-info"><?=$lang->getPhrase('profile.Registration')?> <span class="glyphicon glyphicon-info-sign"></span></a>
	</div>
	<div class="panel-body" id="reg-panel" style="display: none">
		...
		<div class="row btn-vert-block form-group">
			<div class="btn-vert-block col-md-6">
				<input type="email" class="form-control" placeholder="<?=$lang->getPhrase('Email')?>" id="profile-email">
			</div>
			<div class="btn-vert-block col-md-6">
				<input type="password" class="form-control" placeholder="<?=$lang->getPhrase('Password')?>" id="profile-password">
			</div>
		</div>
		<div class="row btn-vert-block">
