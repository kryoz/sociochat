...
class PendingDualsTest extends TestSuite
{
    ...
    public function testEnqueue()
    {
	    ...
	    $user->expects($this->any())->method('getChanelId')->willReturn(1);
	...
	public function testMatch()
	{
		...
		$user1->expects($this->any())->method('getChanelId')->willReturn(1);
		$user2 = $this->getMockUser(TimEnum::SEI);
		$user2->expects($this->any())->method('getChanelId')->willReturn(1);
	...
	{
		$user = $this->getMockUser();
		$user->expects($this->any())->method('getChanelId')->willReturn('_qwerty123');
