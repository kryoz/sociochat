...
class CharTranslatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testToRussianConversion()
    {
        ...
        $this->assertEquals($russian, CharTranslator::toRussian($biLingualChars),
            'bilingual to russian chars conversion failed');
    }
    ...
    public function testToEnglishConversion()
    {
        ...
        $this->assertEquals($english, CharTranslator::toEnglish($biLingualChars),
            'bilingual to english chars conversion failed');
    }
}
